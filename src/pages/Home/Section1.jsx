...
import invest from '../../assets/logo/investopedia.contenthash.cf25078cb7ce013008895c9476ff5a105e96c5c2.svg';
import background1 from '../../assets/logo/backgr.jpg';
import nerdwallet from '../../assets/logo/nerdwallet.contenthash.91486057718363f6a3d741326df4b30d418430e2.svg';
import investopedia from '../../assets/logo/investopedia.contenthash.cf25078cb7ce013008895c9476ff5a105e96c5c2.svg';
import icon from '../../assets/logo/portfolio-icon-sri.contenthash.3151cd8d9142d4ca9f42bb3b4d7a51a369fe8ffa.png';
import icons from '../../assets/logo/portfolio-icon-core.contenthash.ab3ae2470854eb5eb618d2f262727bcb2e6fc19c.png';
  ...
  return (
    <>
      <div data-testid="hero-module">
        <div className="mx-auto grid w-full max-w-[2024px] grid-cols-1 items-center gap-x-4 gap-y-4 px-0 md:w-auto md:grid-cols-12 md:px-12 lg:gap-x-8 lg:px-16 xl:gap-x-12">
            <div className="relative space-y-4 md:order-last md:col-span-8">
                <div className="max-h-full overflow-hidden">
                    <div className="relative flex flex-col">
                        <div className="lg:aspect-4/3 aspect-11/10 relative">
                            <div className="absolute inset-0">
                                <picture>
                                     <source type="image/webp" srcSet={background1}/>
                                    <img className="w-full h-full object-cover rounded-md" width="969" height="710" alt="" loading="eager" src={background1}/>
                                </picture>
                            </div>
                        </div>
                        <div className="absolute inset-0 -bottom-40 top-10 flex items-center justify-center md:bottom-0 md:top-0">
                            <svg viewBox="0 0 398 760" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" className="filter-shadow max-h-full w-full py-8">
                                <g clipPath="url(#7a2ddd64b03adfa074b2bac43b4fa324)">
                                    <rect x="5.375" y="5.375" width="387.25" height="748.25" rx="28.125" fill="#A0A6CF" stroke="#A0A6CF" strokeWidth="11.25"></rect>
                                    <g clipPath="url(#f94b317f95733a8e0373b16cf9414759)">
                                        <rect x="11" y="11" width="376" height="737" rx="22.5" className="fill-current text-space"></rect>
                                        <rect width="375" height="48" transform="translate(11.5 31)" fill="fill-current text-space"></rect>
                                        <path d="M56 56C56.5523 56 57 55.5523 57 55C57 54.4477 56.5523 54 56 54L41.4142 54L45.7071 49.7071C46.0976 49.3166 46.0976 48.6834 45.7071 48.2929C45.3166 47.9024 44.6834 47.9024 44.2929 48.2929L38.2961 54.2896C38.1133 54.4709 38 54.7222 38 55C38 55.2586 38.0982 55.4943 38.2592 55.6718C38.2701 55.6838 38.2814 55.6956 38.2929 55.7071L44.2929 61.7071C44.6834 62.0976 45.3166 62.0976 45.7071 61.7071C46.0976 61.3166 46.0976 60.6834 45.7071 60.2929L41.4142 56L56 56Z" className="fill-current text-blurple-light"></path>
                                        <text className="fill-current text-white" style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                          <tspan x="136" y="62">Classic Portfolio</tspan>
                                        </text>
                                        <text className="fill-current text-blurple-light" style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                            <tspan x="302.748" y="61.555">Manage</tspan>
                                        </text>
                                        <text className="fill-current text-white" style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                            <tspan x="92.5469" y="270.555"></tspan>
                                        </text>
                                        <text className="fill-current text-white" fillOpacity="0.6" style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                            <tspan x="96.7402" y="270.555">all time</tspan>
                                        </text>
                                        <text className="fill-current text-money-in-light" style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                            <tspan x="49.5" y="270.555"></tspan>
                                        </text>
                                        <path d="M40.634 261.389C41.0189 260.722 41.9811 260.722 42.366 261.389L45.8301 267.389C46.215 268.056 45.7339 268.889 44.9641 268.889H38.0359C37.2661 268.889 36.785 268.056 37.1699 267.389L40.634 261.389Z" className="fill-current text-money-in-light"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M161.5 260.667C164.446 260.667 166.833 263.054 166.833 266C166.833 268.946 164.446 271.333 161.5 271.333C158.554 271.333 156.167 268.946 156.167 266C156.167 263.054 158.554 260.667 161.5 260.667ZM161.5 260C158.186 260 155.5 262.686 155.5 266C155.5 269.314 158.186 272 161.5 272C164.814 272 167.5 269.314 167.5 266C167.5 262.686 164.814 260 161.5 260Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <path d="M162.167 263.333C162.167 262.965 161.868 262.667 161.5 262.667C161.132 262.667 160.833 262.965 160.833 263.333C160.833 263.702 161.132 264 161.5 264C161.868 264 162.167 263.702 162.167 263.333Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M161.5 269.333C161.868 269.333 162.167 269.072 162.167 268.75L162.167 265.25C162.167 264.928 161.868 264.667 161.5 264.667C161.132 264.667 160.833 264.928 160.833 265.25L160.833 268.75C160.833 269.072 161.132 269.333 161.5 269.333Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <text className="fill-current text-white"  style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                        ...
                                        <path fillRule="evenodd" clipRule="evenodd" d="M252.5 289.667C255.446 289.667 257.833 292.054 257.833 295C257.833 297.946 255.446 300.333 252.5 300.333C249.554 300.333 247.167 297.946 247.167 295C247.167 292.054 249.554 289.667 252.5 289.667ZM252.5 289C249.186 289 246.5 291.686 246.5 295C246.5 298.314 249.186 301 252.5 301C255.814 301 258.5 298.314 258.5 295C258.5 291.686 255.814 289 252.5 289Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <path d="M253.167 292.333C253.167 291.965 252.868 291.667 252.5 291.667C252.132 291.667 251.833 291.965 251.833 292.333C251.833 292.702 252.132 293 252.5 293C252.868 293 253.167 292.702 253.167 292.333Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M252.5 298.333C252.868 298.333 253.167 298.072 253.167 297.75L253.167 294.25C253.167 293.928 252.868 293.667 252.5 293.667C252.132 293.667 251.833 293.928 251.833 294.25L251.833 297.75C251.833 298.072 252.132 298.333 252.5 298.333Z" className="fill-current text-white" fillOpacity="0.6"></path>
                                        <text className="fill-current text-white"  style={{ whiteSpace: "pre", fontFamily: "Calibre", fontSize: "19", letterSpacing: "0em" }}>
                                        ...
                                        <g opacity="0">
                                            ...
                                            <text className="fill-current text-white" fillOpacity="0.6" style={{whiteSpace:"pre", fontFamily: "Calibre", fontSize:"15", letterSpacing:"0em"}}>
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="9e6cd7dffd1478a43d8811c47c4e72d2" x1="198.75" y1="319" x2="198.75" y2="448" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="currentColor" className="text-blurple"></stop>
                                        <stop offset="1" stopColor="currentColor" className="text-blurple" stopOpacity="0"></stop>
                                    </linearGradient>
                                    <clipPath id="7a2ddd64b03adfa074b2bac43b4fa324">
                                        <rect width="397.5" height="759.5" className="fill-current text-white"></rect>
                                    </clipPath>
                                    <clipPath id="f94b317f95733a8e0373b16cf9414759">
                                        <rect x="11" y="11" width="376" height="737" rx="22.5" className="fill-current text-white"></rect>
                                    </clipPath>
                                    <clipPath id="d7193688909951d73cc6ad7db4bd41e0">
                                        <rect width="376" height="142" className="fill-current text-white" transform="translate(11 319)"></rect>
                                    </clipPath>
                                    <clipPath id="d676c6e54a87447d5f32e6be842cbe87">
                                        <rect width="375" height="45" className="fill-current text-white" transform="translate(11.5 461)"></rect>
                                    </clipPath>
                                    <image id="e317ba06fae500122784155892ef5438" width="200" height="200" src={icon}></image>
                                    <image id="25914ba44a97133e22ba2464a441a139" width="200" height="200" src={icons}></image>
                                </defs>
                            </svg>
                        </div>
                    </div>
            ...
            <div className="space-y-10 p-8 text-eggplant md:p-0 md:col-span-4">
                <div className="order-last w-auto space-y-4 justify-self-center px-0 lg:order-first lg:justify-self-end">
                    <div className="space-y-8 lg:space-y-10 2xl:space-y-12 3xl:space-y-16">
                        <div className="space-y-4">
                            <h1 className="copy-h1-alt">
                                <i>There’s no secret to long-term wealth, but if there were it would be this:</i>
                                <br/>
                                <span className="copy-h1 ">automated index investing.</span>
                            </h1>
                        </div>
                        <div className="space-y-4">
                            <p className="copy-body">Even with the inevitable ups and downs of the market, our expert-built, globally-diversified Automated Investing Account makes it easy to start building long-term wealth by managing your risk, maximizing returns, and minimizing taxes.</p>
                        </div>
                        <div className="flex flex-row md:items-center lg:space-x-8"></div>
                    </div>
                </div>
            </div>
            <div data-testid="accolades-bar" className="text-sm opacity-60 order-last pb-12 pt-4 lg:hidden text-eggplant col-span-full grid grid-cols-2 gap-y-6">
                <div className="col-span-2 mx-auto text-center md:col-span-full flex flex-shrink-0 flex-col space-y-3 items-center">
                    <img width="133" height="21" alt="Nerdwallet logo" loading="lazy" src={nerdwallet}/>
                ...
                <div className="col-span-2 mx-auto md:col-span-full flex flex-shrink-0 flex-col space-y-3 items-center text-center">
                    <img width="133" height="21" className="mt-1" alt="Investopedia logo" loading="lazy" src={invest} />
                    <div className="flex flex-col self-start">
                        <span>
                            Best Robo-advisor, 2022 <sup>1</sup>
                        </span>
                        <span>
                ...
                <div className="flex flex-shrink-0 flex-col space-y-3 items-center text-center">
                    <div data-testid="accolades-num-clients" className="text-h2-mobile font-semibold">690
                ...
                <div class="flex flex-shrink-0 flex-col space-y-3 items-center text-center">
                    <div data-testid="accolades-aum-in-billions" className="text-h2-mobile font-semibold">$43
                    B+</div>
                    <span data-testid="accolades-subtitle">In assets managed</span>
                </div>
                <div className="flex flex-shrink-0 flex-col space-y-3 items-center text-center">
                    <div className="text-h2-mobile font-semibold">
                        <div className="inline-flex items-baseline space-x-2">
                            <span>4.8</span>
                            <svg fill="#230B59" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" className="h-[22px] w-[22px]">
        ...
        <div className="container mx-auto hidden w-full max-w-[2024px] grid-cols-12 gap-x-4 gap-y-4 px-0 py-8 md:px-12 lg:grid lg:gap-x-8 lg:px-16 xl:gap-x-12">
            <div data-testid="accolades-bar" className="text-sm opacity-60 justify-between col-start-1 col-end-13 2xl:col-start-5 2xl:col-end-13 text-eggplant grid auto-cols-auto grid-flow-col grid-rows-[auto,auto] items-center gap-x-6 gap-y-2 2xl:gap-x-10">
                <img width="133" height="21" alt="Nerdwallet logo" loading="lazy" src={nerdwallet}/>
                <div className="flex flex-col self-start">
                    <span className="md:whitespace-nowrap">
                        Best Robo-advisor, Portfolio Options, 2023
                ...
                <img width="133" height="21" className="mt-1" alt="Investopedia logo" loading="lazy" src={investopedia}/>
                <div className="flex flex-col self-start">
                    <span>
                        Best Robo-advisor, 2022 <sup>1</sup>
                    </span>
                ...
                <div data-testid="accolades-num-clients" className="text-h2-mobile font-semibold">690
                K+</div>
                <span data-testid="accolades-subtitle" className="self-start">Trusted clients</span>
                <div data-testid="accolades-aum-in-billions" className="text-h2-mobile font-semibold">
                $43
                B+</div>
                <span data-testid="accolades-subtitle" className="self-start">In assets managed</span>
                <div className="text-h2-mobile font-semibold">
                    <div className="inline-flex items-baseline space-x-2">
                        <span>4.8</span>
                        <svg fill="#230B59" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" className="h-[22px] w-[22px]">
                ...
                <span data-testid="accolades-subtitle" className="self-start">
                    Apple App
                    <span className="md:whitespace-nowrap">
                        Store <sup>2</sup>
                    </span>
